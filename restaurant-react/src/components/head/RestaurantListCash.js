...
class RestaurantListCash extends Component {
    constructor(props) {
        super(props);
        this.state = {
            restaurants: [],
    ...
    infoRestaurant(id) {
        this.props.history.push('/cash', {id: id, back: "head"});
    }
                ...
                <tr key={restaurant.id}>
                    ...
                    <td className="editTd">
                        <Button className="infoButton" color="info" onClick={() => this.infoRestaurant(restaurant.id)}
                                size="sm"><Translate content="cashBalanceShow"/></Button>
                    </td>
                </tr>
            )
        });
...
export default RestaurantListCash;
